...
%% more or less directly to C (puzzle21.c) and got the solution that
%% way.
%%
%% The code below is roughly puzzle21.c translated to erlang.
%%
...
part2() ->
    ...
    %% value of R0 which causes the program to terminate in as few
    ...
    %% eventually repeat, and we want to know the last of the R0
    %% values used before we observe a repetition in the R1
    %% values. This is the (smallest) R0 value which causes the
    %% program to run in as many cycles as possible.
    %%
