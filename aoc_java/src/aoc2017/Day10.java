...
public class Day10 {
    ...
    public int[] knotHashDense(String inputStr) {
    ...
    public String knotHash(String inputStr) {
        return computeHexString(knotHashDense(inputStr));
    }

    public String computeHexString(int[] dense) {
        return Arrays.stream(dense).mapToObj(n -> String.format("%02x", n))
    ...
    public void testReverse() throws Exception {
        assertArrayEquals(new int[] { 4, 3, 2, 1 },
                reverse(new int[] { 1, 2, 3, 4 }, 0, 4));
        assertArrayEquals(new int[] { 3, 2, 1, 4 },
                reverse(new int[] { 1, 2, 3, 4 }, 2, 3));
        assertArrayEquals(new int[] { 6, 5, 3, 4, 2, 1 },
                reverse(new int[] { 1, 2, 3, 4, 5, 6 }, 4, 4));
    }

    @Test
    public void testComputeDenseHash() throws Exception {
        assertEquals(64, computeDenseHash(new int[] { 65, 27, 9, 1, 4, 3, 40,
                50, 91, 7, 6, 0, 2, 5, 68, 22 }, 0, 16));
    }

    @Test
    public void testPart1_small() throws Exception {
        assertEquals(12,
                knotHashSingleIter(makeInput(5), new int[] { 3, 4, 1, 5 }));
    }

    @Test
    public void testPart1_full() throws Exception {
        assertEquals(38628,
                knotHashSingleIter(makeInput(256),
                        new int[] { 130, 126, 1, 11, 140, 2, 255, 207, 18, 254,
                                246, 164, 29, 104, 0, 224 }));
    }

    @Test
    public void testMakeLengths() throws Exception {
        assertArrayEquals(new int[] { 49, 44, 50, 44, 51, 17, 31, 73, 47, 23 },
                makeLengths("1,2,3"));
    }
