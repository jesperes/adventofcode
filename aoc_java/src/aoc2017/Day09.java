...
public class Day09 {
    ...
    public void testPart1_short() throws Exception {
        interpret("<>");
        interpret("<43095803248529387452435>");
        interpret("<<<<>");
        interpret("<{!>}>");
        interpret("<!!>");
        interpret("<!!!>>");
        ...
        assertEquals(1, interpret("{}"));
        assertEquals(6, interpret("{{{}}}"));
        assertEquals(5, interpret("{{},{}}"));
        assertEquals(16, interpret("{{{},{},{{}}}}"));
        assertEquals(1, interpret("{<a>,<a>,<a>,<a>}"));
        assertEquals(9, interpret("{{<ab>},{<ab>},{<ab>},{<ab>}}"));
        assertEquals(9, interpret("{{<!!>},{<!!>},{<!!>},{<!!>}}"));
        assertEquals(3, interpret("{{<a!>},{<a!>},{<a!>},{<ab>}}"));
    }
}
