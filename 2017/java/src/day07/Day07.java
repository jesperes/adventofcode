...
public class Day07 {
	...
	public void testPart1_full() throws Exception {
		try (BufferedReader inputReader = new BufferedReader(
				new InputStreamReader(Day05.class.getClassLoader()
						.getResourceAsStream("day07/input.txt")))) {
			String[] puzzleInput = inputReader.lines()
					.toArray(n -> new String[n]);
			Node root = getRootNode(puzzleInput);
			System.out.println("[Day07]: Program name at root: " + root.name);
		}
	}
	...
	public void testPart2_full() throws Exception {
		try (BufferedReader inputReader = new BufferedReader(
			...
			System.out.println(
					"[Day07]: Weight of unbalanced program: " + weight);
		}
	}
}
