...
%%%
%%% @end
%%% Created : 14 Jan 2019 by Jesper Eskilson <jesper.eskilson@klarna.com>
...
run(Filename, MaxCycles, A) ->    
    Program = parse_prog(Filename),
    interpret(0, Program, #{"a" => A}, MaxCycles).

find_clock_input() ->
    Prog = parse_prog("input.txt"),
